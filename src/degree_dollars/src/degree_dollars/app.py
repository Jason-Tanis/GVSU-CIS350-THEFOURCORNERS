    ...
    async def display_transaction_history(self, month, year):
        ...
        if transactions:
            for trans in transactions:
                ...
                amount_label = toga.Label(
                    f"{sign}${amount:.2f}",
                    style=Pack(font_size=18, color=color, padding_bottom=5)
                )
                
                amount_box = toga.Box(
                    style=Pack(direction=COLUMN, alignment=LEFT, width=80)
                )
                ...
                merchant_label = toga.Label(
                    merchant,
                    style=Pack(font_size=16, color="#000000", padding_bottom=3)
                )
                subsection_label = toga.Label(
                    subsec.capitalize(),
                    style=Pack(font_size=18, font_weight="bold", color="#000000", padding_bottom=5)
                )
                
                text_box = toga.Box(
                    style=Pack(direction=COLUMN, width=160)
                )
                ...
                month_label = toga.Label(
                    date.strftime('%b'),
                    style=Pack(font_size=14, font_weight="bold", color="#000000", text_align=CENTER)
                )
                day_label = toga.Label(
                    str(date.day),
                    style=Pack(font_size=14, color="#000000", text_align=CENTER)
                )
            ...
            history_box.add(toga.Label("No transactions found.", style=Pack(font_size=14, color="#000000", padding=10)))
